...
// moved all starter logic and starter DOM updates here to facilitate testing
// and called this StarterLogic function in the script tag of index.html

function StarterLogic() {
...
// exporting the functions to allow testing.
module.exports = {
    setInitialOverlay,
    setOverlay,
    generateRooms,
